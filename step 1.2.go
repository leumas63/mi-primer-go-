...
func main() {
	archivos, err := ioutil.ReadDir("D:\\Users\\Cristian\\Documents\\2023-1\\Computacion Nube\\Pruebas") //Direccion compañero: C:\\Users\\pc\\Desktop\\8\\Computacion en la nube\\mi-primer-go\\imagenes
	if err != nil {
		log.Fatal(err)
	}
